...
class _OrderApprovalScreenState extends State<OrderApprovalScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
                ...
                children: [
                  ...
                  Center(
                      child: Text(
                          ...
                          style: const TextStyle(color: TColors.primary, fontWeight: FontWeight.bold, letterSpacing: 0.5)
                      )
                  ),
                ],
              ),
              ...
              // --- 3. MULTI-ITEM PRODUCT SPECIFICATIONS ---
              _buildModernCard(
              ...
              _buildModernCard(
                ...
                children: [
                  ...
                  Container(
                    padding: const EdgeInsets.all(16),
                    decoration: BoxDecoration(
                        color: localBalanceDue <= 0 ? Colors.green.withValues(alpha: 0.1) : Colors.red.withValues(alpha: 0.1),
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(color: localBalanceDue <= 0 ? Colors.green.withValues(alpha: 0.3) : Colors.red.withValues(alpha: 0.2))
                    ),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
              ...
              // --- 5. PENDING PAYMENT REQUESTS STREAM ---
                          ...
                          children: [
                            const Row(
                              children: [
                                ...
                                SizedBox(width: 8),
                                Text("Payment Approval Required", style: TextStyle(color: Colors.orange, fontWeight: FontWeight.bold, fontSize: 16)),
                              ],
                            ),
                            const SizedBox(height: 8),
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: ElevatedButton(
                                    onPressed: isProcessingPayment ? null : () {
                                      HapticFeedback.lightImpact();
                                      _approvePaymentRequest(doc.id, amount, order.id!);
                                    },
                    ...
                    if (statusCheck == 'placed' || statusCheck == 'pending') {
                      ...
                      return Column(
                        children: [
                          ...
                          const SizedBox(height: 12),
                          // HISTORY BUTTON WHEN ALREADY APPROVED/REJECTED
                          SizedBox(
                            width: double.infinity,
  ...
  Widget _buildStatusHeader(OrderModel order) {
    return Container(
      ...
      decoration: BoxDecoration(
          gradient: LinearGradient(colors: [Colors.orange.shade400, Colors.deepOrangeAccent], begin: Alignment.topLeft, end: Alignment.bottomRight),
          borderRadius: BorderRadius.circular(16),
          ...
          Row(
            ...
            children: [
              ...
              Container(
                  ...
                  child: Text(currentStatus.toUpperCase(), style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 12))
              ),
            ],
          ),
          const SizedBox(height: 4),
